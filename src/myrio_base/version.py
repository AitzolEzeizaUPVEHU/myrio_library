...
1.4.1: Added new features and improvements (2025/09/25)
1.4.2: Fixed minor bug in the setup.py file (2025/09/26)
1.4.3: PEP 625 compliance (2025/09/26)
1.4.7: Fixed minor bug in the example files (2025/09/26)
"""
